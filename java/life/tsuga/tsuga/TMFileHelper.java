...
public class TMFileHelper {
	...
	public static final String TAG = TMFileHelper.class.getSimpleName();
	
	public static final int SHORT_SIDE_TARGET = 160;

	public static byte[] getByteArrayFromFile(Context context, Uri uri) {
		byte[] tMFileBytes = null;
        ...
        if (uri.getScheme().equals("content")) {
        	try {
        		...
        		tMFileBytes = outStream.toByteArray();
        	}
	        catch (IOException e) {
        	...
        	try {
	        	...
	        	tMFileBytes = IOUtils.toByteArray(fileInput);
        	}
        	catch (IOException e) {
        		Log.e(TAG, e.getMessage());
        	}
